...
enum PendingEndpoint {
  ...
  servisAjuan('/servis-armada'),
  workshopTodoPhoto('/workshop/job/{id}/todo/{todoId}/photo'),
  workshopRequestSparepart('/workshop/job/{id}/request-sparepart');
