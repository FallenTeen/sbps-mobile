...
class PendingSummary {
  ...
  Future<ModulePendingCounts> getSummary(String role) async {
    ...
    final armadaCount = pendingActions
        .where(
          (a) =>
    ...
    final produksiCount = pendingActions
        .where(
          (a) =>
    ...
    final workshopCount = pendingActions
        .where(
          (a) =>
              a.endpoint ==
              PendingEndpoint
                  .armadaChecklist, // Workshop may use similar endpoints
        )
        .length;
